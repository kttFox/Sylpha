...
namespace Sylpha.Commands {
	...
	public sealed class ListenerCommand<T> : Command, ICommand, INotifyPropertyChanged {
		...
		public ListenerCommand( Action<T?> execute, Func<bool>? canExecute = null ) {
		...
		private void OnPropertyChanged() {
			this.PropertyChanged?.Invoke( this, EventArgsFactory.GetPropertyChangedEventArgs( nameof( CanExecute ) ) );
		}
